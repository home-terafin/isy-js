...
const InsteonDimmableDevice_1 = require("./Insteon/InsteonDimmableDevice");
const InsteonDimmerOutletDevice_1 = require("./Insteon/InsteonDimmerOutletDevice");
const InsteonDimmerSwitchDevice_1 = require("./Insteon/InsteonDimmerSwitchDevice");
const InsteonDoorWindowSensorDevice_1 = require("./Insteon/InsteonDoorWindowSensorDevice");
const InsteonFanDevice_1 = require("./Insteon/InsteonFanDevice");
const InsteonKeypadDevice_1 = require("./Insteon/InsteonKeypadDevice");
const InsteonKeypadDimmerDevice_1 = require("./Insteon/InsteonKeypadDimmerDevice");
const InsteonKeypadRelayDevice_1 = require("./Insteon/InsteonKeypadRelayDevice");
const InsteonLeakSensorDevice_1 = require("./Insteon/InsteonLeakSensorDevice");
const InsteonMotionSensorDevice_1 = require("./Insteon/InsteonMotionSensorDevice");
const InsteonOnOffOutletDevice_1 = require("./Insteon/InsteonOnOffOutletDevice");
const InsteonRelayDevice_1 = require("./Insteon/InsteonRelayDevice");
const InsteonRelaySwitchDevice_1 = require("./Insteon/InsteonRelaySwitchDevice");
...
class InsteonDeviceFactory {
    static getDeviceDetails(node) {
        var _a;
        const family = Number((_a = node.family) !== null && _a !== void 0 ? _a : '1');
    ...
    static getInsteonDeviceDetails(typeCode, node) {
        ...
        else if (category === 0o009 || category === 0o011) {
    ...
    static getNLSDimLightInfo(deviceCode, subAddress, node) {
        ...
        if ((retVal === null || retVal === void 0 ? void 0 : retVal.class) === undefined) {
